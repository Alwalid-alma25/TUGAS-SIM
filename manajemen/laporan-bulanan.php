            ...
            <section class="col-lg-12">
                ...
                <div class="box box-info">
                    ...
                    <div class="box-body">
                        ...
                        <?php
                        if (isset($_GET['bulan']) && isset($_GET['kategori'])) {
                        ...
                        ?>
                            ...
                            <a href="laporan_pdf.php?bulan=<?php echo $bln ?>&kategori=<?php echo $kategori ?>" target="_blank" class="btn btn-sm btn-success"><i class="fa fa-file-pdf-o"></i> &nbsp CETAK PDF</a>
                            <a href="laporan_print.php?bulan=<?php echo $bln ?>&kategori=<?php echo $kategori ?>" target="_blank" class="btn btn-sm btn-primary"><i class="fa fa-print"></i> &nbsp PRINT</a>
                                ...
                                <table class="table table-bordered table-striped">
                                    ...
                                    <tbody>
                                        ...
                                        if ($kategori == "semua") {
                                            ...
                                            $data = mysqli_query($koneksi, "SELECT * FROM transaksi,kategori where kategori_id=transaksi_kategori and date(transaksi_tanggal) ='$bln'");
                                        } else {
                                            $data = mysqli_query($koneksi, "SELECT * FROM transaksi,kategori where kategori_id=transaksi_kategori and kategori_id='$kategori' and date(transaksi_tanggal)='$bln'");
                                        }
