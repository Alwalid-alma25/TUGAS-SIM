...
<head>
  ...
  <title>Manajemen - Sistem Informasi Manajemen Keuangan</title>
  ...
  <div class="wrapper">
    ...
    <header class="main-header">
      <a href="index.php" class="logo">
        ...
        <span class="logo-lg"><b>SIM</b>Keuangan</span>
      </a>
    ...
    <aside class="main-sidebar">
      <section class="sidebar">
        ...
        <ul class="sidebar-menu" data-widget="tree">
          ...
          <li>
            <a href="bank.php">
              <i class="fa fa-building"></i> <span>Rekening</span>
            </a>
          </li>
          ...
          <li class="treeview">
            ...
            <ul class="treeview-menu" style="display: none;">
              <li><a href="laporan.php"><i class="fa fa-file"></i>Laporan Hariain</a></li>
              <li><a href="laporan-bulanan.php"><i class="fa fa-file"></i>Laporan Bulanan</a></li>
              <li><a href="laporan-tahunan.php"><i class="fa fa-file"></i>Laporan Tahunan</a></li>
              <li><a href="laporan-labarugi.php"><i class="fa fa-file"></i>Laporan laba-rugi</a></li>
            </ul>
          </li>
