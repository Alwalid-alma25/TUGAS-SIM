                  ...
                  <div class="modal-content">
                    ...
                    <div class="modal-body">
                      ...
                      <div class="form-group">
                        ...
                        <input type="text" name="pemilik" class="form-control" placeholder="Nama pemiliki Rekening ..">
                      </div>

                      <div class="form-group">
                        <label>Nomor Rekening</label>
                        <input type="text" name="nomor" class="form-control" placeholder="Nomor Rekening ..">
                      </div>
                            ...
                            <div class="modal-dialog" role="document">
                              <div class="modal-content">
                                ...
                                <div class="modal-body">
                                  ...
                                  <div class="form-group" style="margin-bottom:15px;width: 100%">
                                    <label>Nama Pemilik Rekening</label>
                                    <input type="text" name="pemilik" style="width:100%" class="form-control" placeholder="Nama pemiliki Rekening .." value="<?php echo $d['bank_pemilik']; ?>">
                                  </div>

                                  <div class="form-group" style="margin-bottom:15px;width: 100%">
                                    <label>Nomor Rekening</label>
                                    <input type="text" name="nomor" style="width:100%" class="form-control" placeholder="Nomor Rekening .." value="<?php echo $d['bank_nomor']; ?>">
                                  </div>
