  ...
  <section class="content">
    ...
    <div class="row">
      ...
      <section class="col-lg-4">
        ...
        <div class="box box-solid bg-green-gradient">
          <div class="box-header">
            <h3 class="box-title">By Group 3 <br><h4> Aldi fahroza  /<b>11950314484</b>
            <br>Walid alma ula / <b>11950315054</b>
            <br> Siti sarah / <b>11950325027</b></h4></h3>
          </div>
          <!-- /.box-header -->
          <div class="box-body no-padding">
            <!--The cp -->
            <div id="cp" style="width: 100%"></div>
          </div>
          <!-- /.box-body -->
        </div>
