            ...
            <div class="table-responsive">
              <table class="table table-bordered table-striped" id="table-datatable">
                ...
                <tbody>
                  ...
                  include '../koneksi.php';
                  $no=1;
                  $data = mysqli_query($koneksi,"SELECT * FROM transaksi,kategori,barang where kategori_id=transaksi_kategori AND barang_id=transaksi_barang order by transaksi_id desc");
