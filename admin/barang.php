                  ...
                  <div class="modal-content">
                    ...
                    <div class="modal-body">
                      ...
                      <div class="form-group">
                        ...
                        <input type="text" name="barang" required="required" class="form-control" placeholder="Nama Barang ..">
                      </div>
            ...
            <div class="table-responsive">
              <table class="table table-bordered table-striped" id="table-datatable">
                ...
                <tbody>
                  ...
                  include '../koneksi.php';
                  $no=1;
                  $data = mysqli_query($koneksi,"SELECT * FROM barang ORDER BY barang ASC");
                              ...
                              <div class="modal-content">
                                ...
                                <div class="modal-body">
                                  ...
                                  <div class="form-group" style="width:100%">
                                    ...
                                    <input type="text" name="barang" required="required" class="form-control" placeholder="Nama Barang .." value="<?php echo $d['barang']; ?>" style="width:100%">
                                  </div>
